    ...
    a.extend(a.fn, {
        ...
        ckeditor: function(g, e) {
            ...
            this.each(function() {
                ...
                else if (f) c.once("instanceReady", function() { setTimeout(function d() { c.element ? (c.element.$ == h && g && g.apply(c, [h]), l.resolve()) : setTimeout(d, 100) }, 0) }, null, null,
                    9999);
                else {
                    ...
                    c.on("instanceReady", function(e) {
                        ...
                        setTimeout(function n() {
                            if (d.element) {
                                ...
                                d.on("save", function() { a(h.form).trigger("submit"); return !1 }, null, null, 20);
